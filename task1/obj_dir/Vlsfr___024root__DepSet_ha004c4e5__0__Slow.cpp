...
VL_ATTR_COLD void Vlsfr___024root___settle__TOP__0(Vlsfr___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vlsfr__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlsfr___024root___settle__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vlsfr___024root___eval_settle(Vlsfr___024root* vlSelf) {
    ...
    // Body
    Vlsfr___024root___settle__TOP__0(vlSelf);
}

VL_ATTR_COLD void Vlsfr___024root___final(Vlsfr___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vlsfr__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlsfr___024root___final\n"); );
}
